#!/usr/bin/env python3
"""subagent-bouncer (Opus 4.8 ceiling): no model, no entry.
...
Opus-ceiling variant: routing table tops out at Opus 4.8 (no fable tier).
Use this build on sessions/accounts where fable is unavailable. The
fable-ceiling build lives in subagent_bouncer.py.
"""
...
REASON = (
    ...
    "adversarial verification, and judgment-critical cross-cutting synthesis. "
    "Pick the cheapest capable tier. In the re-issued prompt, "
...
WORKFLOW_REASON = (
    ...
    "debugging, adversarial verification, and judgment-critical cross-cutting "
    "synthesis. Unrouted spawns "
